        ...
        $(function () {
                ...
                $(".filter-button").on("click",
                    function (event) {
                        ...
                        if (value != "all") {
                                $('.list__item[data-purpose != ' + value + ']')
                                    .css('display', 'none');
                        }
                });

                $('#smallCategory').on('change',
                    function (event) {
            ...
            <div class="container">
                ...
                <div class="double__elem">
                    ...
                    <div class="left__right">
                        <select id="smallCategory" name="smallCategory" class="selectpicker"
                                data-style="btn-success" multiple data-max-option="3" data-live-search="true">
            ...
            <div class="borad_list__wrap">
                <ul class="borad_list">
                    ...
                    <c:forEach var="board" items="${ boards }">
                        <li class="list__item" data-purpose='${ board.purpose }'
                            data-category='${board.smallCategoryName[0].smallCategoryName}'
                            data-category2='${board.smallCategoryName[0].smallCategoryNo}'>
                            <div class="board_item__wrap">
                                <div class="item__pics">
                                    <img src="/studyCafe/resources/boardimage/${board.boardNo}.jpg" alt=""/>
                                </div>

                                <ul class="list_info">
                                    <li class="list_detail__over"><strong>제목</strong>
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <a id="board_item_a" href='detail.action?boardno=${ board.boardNo }'>
                                                    ${ board.title }
                                                </a>
                                            </c:otherwise>
                                        </c:choose>
                                        ...
                                        <div class="list_detail__wrap">
                                            <div class="list_detail">
                                                <ul class="list_detail_info">
                                                    ...
                                                    <li><strong>모집 마감일</strong>
                                                        <span>${ board.closeDate }</span>
                                                    </li>
                                                </ul>
                                            </div>
                                            <span class="bg"></span>
                                    ...
                                    <li><strong>작성자</strong>
                                        <span>
                                            <%--board.memberId를 variable member로 만들어서 돌리는데, ${member}만 하면 되지 않나? --%>
                                        ...
                                        <c:choose>
                                            <c:when test="${ board.status eq '0' }">
                                                <button type="button" value="모집종료" class="btn btn-danger"
                                                        onclick="alert('모집 마감 되었습니다.');">모집종료
                                                </button>
                                            </c:when>
