			...
			onlogin="checkLoginState();" autologoutlink="true">
		        ...
		        <table>
		        	<tr>
		        		  <th>페이스북 로그인</th>
		        		 <td>
		                    <input type="button" id="login" name="login" style="width:280px" value="로그인"/>
		        			  <input type="button" id="logout" name="logout" style="width:280px" value="로그아웃"/>
		        		  </td> 
		        	</tr>
		            <tr>
		                <th>아이디(ID)</th>
