						...
						<c:otherwise>
							<tr style="height: 30px">
								...
								<td style="text-align: left; padding-left: 10px">
									<a href='view.action?uploadno=${ upload.uploadNo }&memberpageno=${memberpageno}&noticemenu=${noticemenu.menuNo}'>
										${ upload.title }
									</a>
								</td>
								<td>
				...
				<div class="row">
					...
					<div class="col-md-4">
						...
						<button type="button" value="자료등록" class="btn btn-primary btn-sm"
								onclick="location.href='write.action?' +
