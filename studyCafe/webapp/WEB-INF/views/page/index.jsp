        ...
        <div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar">
            <div class="list-group" style="text-align: center">
                ...
                <h4 class="panel-title"><a
                        href="/studyCafe/upload/list.action?memberpageno=${memberpageno}&noticemenu=${noticemenu.menuNo}"
                        class="list-group-item">자료실</a></h4>
                <h4 class="panel-title"><a
                        href="/studyCafe/calendar/list.action?memberpageno=${memberpageno}&noticemenu=${noticemenu.menuNo}"
                        class="list-group-item">일정</a></h4>
