        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body" align="center">
                    <p> <!-- 여기는 내용이 들어 가는 곳 --> <input type="button" class="btn btn-primary" id="login"
                                                        style="width:350px; height:60px" value="페이스북 계정으로 로그인"></p>
                    <div class="signup-or-separator">
                        <span style="position:'absolute';top:500;">or</span>
                        <hr>
                    </div>
                    <p><!-- 여기는 내용이 들어 가는 곳 --><input class="form-control" name="email" type="text"
                                                      style="width:350px; height:60px" value="이메일 주소"></p>
                    <p><!-- 여기는 내용이 들어 가는 곳 --><input class="form-control" name="passwd" type="text"
                                                      style="width:350px; height:60px" value="비밀번호"></p>
                </div>
